...
//机型判断
let iPhone5 = (Main_Screen_Height == 568) ? true : false
...
let YCColorDarkRed = gof_ColorWithHex(0xFF2600);     // 主色调，深红色
let YCColorMain = gof_ColorWithHex(0x1C2029);     // 主色调，棕色
let YCColorGreen = gof_ColorWithHex(0x0BC269);     // 主色调，绿色
let YCColorDarkGreen = gof_ColorWithHex(0x55DC87);     // 主色调，深绿色
let YCColorYellow = gof_ColorWithHex(0xF5C637);     // 主色调，黄色
let YCColorWhite = gof_ColorWithHex(0xFFFFFF);     // 主色调，白色
let YCColorBlack = gof_ColorWithHex(0x000000);   // 主色调，纯黑色
...
var YC_FONT_PFSC_Semibold: (CGFloat) -> UIFont = {size in
    ...
    return UIFont(name: "PingFangSC-Semibold", size: sizes) ?? UIFont.systemFont(ofSize: sizes)
}
...
var YC_FONT_PFSC_Regular: (CGFloat) -> UIFont = {size in
    ...
    return UIFont(name: "PingFangSC-Regular", size: sizes) ?? UIFont.systemFont(ofSize: sizes)
}
var YC_FONT_PFSC_Light: (CGFloat) -> UIFont = {size in
    ...
    return UIFont(name: "PingFangSC-Light", size: sizes) ?? UIFont.systemFont(ofSize: sizes)
}
//富文本设置行间距
