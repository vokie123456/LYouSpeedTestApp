...
class LYBaseH5Controller: LYBaseController,WKNavigationDelegate,WKUIDelegate {
    // webView
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        webView = WKWebView( frame: CGRect(x:0,y:Int(0),width:Int(Main_Screen_Width),height:(Int(Main_Screen_Height-NaviBarHeight))))
        /// 设置代理
