...
@implementation LYouLoadingView
+ (void)show {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        if (activiyView == nil) {
            CGRect rect = [UIScreen mainScreen].bounds;
            activiyView = [[LYouLoadingView alloc] initWithFrame:rect];
            activiyView.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.0];
        }
    });
...
//        contentView.layer.shadowOffset = CGSizeMake(1, 1);
        ...
        contentView.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.0];
